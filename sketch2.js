let capture;
        ...
        function drawSeparatorLine() {
            // Draw vertical line to separate left negative space from content area
            let separatorX = width * 0.3; // Line at 30% from left
            let padding = 40;
        ...
        function drawLargeCameraView() {
            if (capture && capture.loadedmetadata) {
                let separatorX = width * 0.3; // Content starts after 30%
                let padding = 40;
